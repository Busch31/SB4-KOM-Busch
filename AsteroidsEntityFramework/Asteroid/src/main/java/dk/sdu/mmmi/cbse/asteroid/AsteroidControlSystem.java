...
public class AsteroidControlSystem implements IEntityProcessingService {
    ...
    public void process(GameData gameData, World world) {
        ...
        for (Entity asteroid : world.getEntities(dk.sdu.mmmi.cbse.asteroid.Asteroid.class)) {
            ...
            // print size
            Asteroid asteroidType = (Asteroid) asteroid;
            System.out.println(asteroidType.getSize());
    ...
    private void updateShape(Entity asteroid) {
        ...
        dk.sdu.mmmi.cbse.asteroid.Asteroid asAsteroid = (dk.sdu.mmmi.cbse.asteroid.Asteroid) asteroid;
